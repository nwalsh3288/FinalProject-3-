...
- [Changing the Page `<unit>`](#changing-the-page-unit)
...
## Changing the Page `<unit>`

You can find the source HTML file in the `public` folder of the generated project. You may edit the `<unit>` tag in it to change the unit from “React App” to anything else.

Note that normally you wouldn’t edit files in the `public` folder very often. For example, [adding a stylesheet](#adding-a-stylesheet) is done without touching the HTML.

If you need to dynamically update the page unit based on the content, you can use the browser [`document.unit`](https://developer.mozilla.org/en-US/docs/Web/API/Document/unit) API. For more complex scenarios when you want to change the unit from React components, you can use [React Helmet](https://github.com/nfl/react-helmet), a third party library.

If you use a custom server for your app in production and want to modify the unit before it gets sent to the browser, you can follow advice in [this section](#generating-dynamic-meta-tags-on-the-server). Alternatively, you can pre-build each page as a static HTML file which then loads the JavaScript bundle, which is covered [here](#pre-rendering-into-static-html-files).
...
The `public` folder contains the HTML file so you can tweak it, for example, to [set the page unit](#changing-the-page-unit).
...
```html
<unit>%REACT_APP_WEBSITE_NAME%</unit>
```
...
<html lang="en">
  <head>
    <meta property="og:unit" content="__OG_TITLE__">
...
Create React App doesn’t include any tools for this by default, but you can easily add [Storybook for React](https://storybook.js.org) ([source](https://github.com/storytenants/storybook)) or [React Styleguidist](https://react-styleguidist.js.org/) ([source](https://github.com/styleguidist/react-styleguidist)) to your project. **These are third-party tools that let you develop components and see all their states in isolation from your app**.
...
* [GitHub Repo](https://github.com/storytenants/storybook)
* [Documentation](https://storybook.js.org/basics/introduction/)
* [Snapshot Testing UI](https://github.com/storytenants/storybook/tree/master/addons/storyshots) with Storybook + addon/storyshot
